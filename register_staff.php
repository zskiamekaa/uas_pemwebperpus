...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $id_role = 2; // Role staff
    $status_akun = 'aktif';

    // Validasi panjang password
    if (strlen($password) < 6 || strlen($password) > 20) {
        $error_msg = "Panjang password harus antara 6 hingga 20 karakter.";
    } else {
        ...
        try {
            ...
            // Insert ke t_staff
            $sql_staff = "INSERT INTO t_staff (id_account, nama, email, telepon, alamat) VALUES (?, ?, ?, ?, ?)";
            ...
            mysqli_commit($conn);
            $success_msg = "Registrasi Staff berhasil!";
        } catch (Exception $e) {
