...
$id = $_GET['id'];
$query = mysqli_query($conn, "SELECT * FROM t_buku WHERE id_buku = '$id'");
...
<div class="main">
    ...
    <form method="POST">
        ...
        <input type="number" name="tahun" value="<?= htmlspecialchars($buku['tahun_terbit']) ?>" required>
